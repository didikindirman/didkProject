        ...
        <div class="row">
          <div class="col-8">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="kamar_tambah_prs.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">nomor_kamar</label>
                    <input type="text" name="nomor_kamar" class="form-control" placeholder="Enter nomor_kamar">
                  </div>
				  
				  <div class="form-group">
                    <label for="exampleInputEmail1">tipe_kamar</label>
                    <input type="text" name="tipe_kamar" class="form-control" placeholder="Enter tipe_kamar">
                  </div>
