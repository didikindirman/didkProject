              ...
              <form role="form" action="tamu_tambah_prs.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="id_KTP" class="form-control" placeholder="Enter id_KTP">
                  </div>
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" name="no_telepon" class="form-control" placeholder="Enter no_telepon">
                  </div>
