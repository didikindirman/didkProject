          ...
          <div class="col-8">
            ...
            <div class="card">
			  ...
			  <?php 
				...
				?>
              <form role="form" action="resepsionis_edit_prs.php" method="POST">
			  ...
			  <label for="exampleInputEmail1">id_resepsionis</label>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">nama_resepsionis</label>
                    <input type="text" name="nama_resepsionis" class="form-control" value="<?php echo $data['nama_resepsionis'] ?>" required>
                  </div
